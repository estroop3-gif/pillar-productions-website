...
export default function CoastalTorquePage() {
  return (
    <PageShell>
      {/* Hero */}
      <section className="pt-16 lg:pt-24 pb-16 lg:pb-20">
        <div className="max-w-6xl mx-auto px-4 lg:px-12">
          <p className="text-xs tracking-[0.25em] uppercase text-neutral-500 mb-6">
            Flagship &middot; Docu series &middot; In production
          </p>
          ...
          <p className="text-lg lg:text-xl text-neutral-400 leading-relaxed max-w-3xl">
            A motorsports docu series set in Sarasota, following builders, drivers,
            and dreamers chasing speed, community, and calling on and off the track.
          </p>
        </div>
      </section>
