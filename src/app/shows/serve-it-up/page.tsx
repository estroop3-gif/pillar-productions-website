...
const TRAILER = { id: "jz8vp9Jismc" };

const EPISODES = [
  { number: 1, videoId: null, thumb: null },
  { number: 2, videoId: null, thumb: null },
  { number: 3, videoId: null, thumb: null },
  { number: 4, videoId: null, thumb: null },
...
export default function ServeItUpPage() {
  return (
    <PageShell>
      {/* Hero */}
      <section className="pt-16 lg:pt-24 pb-16 lg:pb-20">
        <div className="max-w-6xl mx-auto px-4 lg:px-12">
          <p className="text-xs tracking-[0.25em] uppercase text-neutral-500 mb-6">
            Flagship &middot; Competition reality &middot; In development
          </p>
          ...
          <p className="text-lg lg:text-xl text-neutral-400 leading-relaxed max-w-3xl">
            Twelve contestants, six pros and six amateurs, compete across a full
            season of pickleball. Pros and amateurs live in two separate houses.
            Each week, every pro is paired with a different beginner. Every third
            episode culminates in a tournament. Point standings are never revealed
            to the players. At the end of the season, the top scoring pro and the
            top scoring amateur split a $10,000 prize.
          </p>
        </div>
      </section>
