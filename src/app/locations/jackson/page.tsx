...
export const metadata: Metadata = {
  title: "Jackson, Mississippi – Coming Soon | Pillar Productions",
  description:
    "Pillar Productions in Jackson, Mississippi. Stories shaped by faith, resilience, and Southern culture. Coming soon.",
};
      ...
      <main className="min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-6xl mx-auto px-4 lg:px-12 text-center">
          ...
          <p className="text-lg lg:text-xl text-neutral-400 leading-relaxed mb-10 max-w-2xl mx-auto">
            Rooted in the heart of the South, telling stories shaped by faith, resilience, and culture. More details coming soon.
          </p>
