...
export const metadata: Metadata = {
  title: "McAllen, Texas – Coming Soon | Pillar Productions",
  description:
    "Pillar Productions in McAllen, Texas. Storytelling at the crossroads of American and Latin culture. Coming soon.",
};
      ...
      <main className="min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-6xl mx-auto px-4 lg:px-12 text-center">
          ...
          <p className="text-lg lg:text-xl text-neutral-400 leading-relaxed mb-10 max-w-2xl mx-auto">
            Positioned at the crossroads of American and Latin culture in the Rio Grande Valley. More details coming soon.
          </p>
